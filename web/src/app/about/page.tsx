export const metadata = { title: "About · Fibrescope" };
...
export default function About() {
  return (
    <div className="prose">
      ...
      <h2>Data</h2>
      <ul>
        <li>Raw probe rows are kept indefinitely. The API that serves this site (<code>/v1/probes</code>) is documented on the API page but is not a public service yet; the raw files can be shared on request.</li>

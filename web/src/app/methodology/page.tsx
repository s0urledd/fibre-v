...
export default function Methodology() {
  return (
    <>
      ...
      <p>Which validators land inside the quorum is a <strong>race, not a list</strong>. Membership follows the order the signatures arrive in, so the same validator is inside on one blob and outside on the next, and being outside carries no information about the operator. Simulating the mocha validator set (79 validators, 322,778,683 total voting power) over 20,000 random arrival orders: the quorum holds a <strong>median of 53 of 79</strong> validators, and the chance of being in it is flat across stake — 68.9% for the largest ten, 66.5% for the smallest twenty-four. The smallest quorum the set can produce is 30, the case where the largest validators all answer first, and that is a bound rather than an expectation.</p>
      <p>A validator with a long run of unproven obligations is therefore telling you about the network&rsquo;s timing, not about itself. That is exactly why this site leads each validator&rsquo;s page with reachability and certificate validity: those come from a heartbeat that dials every registered endpoint every ten minutes whether or not anything was assigned, so their coverage does not depend on a quorum anyone happened to be in.</p>

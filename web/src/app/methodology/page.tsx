...
export default function Methodology() {
  return (
    <>
      ...
      <ul>
        <li><strong>Serve rate</strong> = HEALTHY / (HEALTHY + FAULT), over probes of assigned shards in the in-window and grace phases whose obligation the settled promise proves. TOLERATED, UNATTESTED, EXPECTED_GONE, post-window classes and gaps are listed next to the rate, never folded in.</li>
